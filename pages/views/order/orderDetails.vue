  ...
  <view class="order_more">
    ...
    <view class="tips">
      ...
      <view class="textarea_box">
        <textarea placeholder="Please enter the remark" disabled="true" placeholder-class="font-size: 24upx" maxlength="-1" v-model="orderList.tips"></textarea>
      </view>
    </view>
    </view>
    <view class="bottom_btn" >
		<block v-if="status == 0">
			<view class="moneys">
			Total: <text :style="'color:' + colors + ';'">￥{{orderList.sumprice}}</text>
			</view>
