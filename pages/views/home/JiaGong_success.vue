...
<view class="jieguo" :style="{background: colors}">
 <view class="place">
  ...
  <view class="jieguo_box">
    ...
    <view class="texts">Solution selected</view>
    <!-- <view class="moneys">￥35.9</view> -->
    <view class="wancheng" @tap="onsuccess" :style="'color:' + colors + ';border-color:' + colors">Completed</view>
    <view class="ewm" @tap="jumpUser">Returning to the personal center>>></view>
  </view>
</view>
</template>
