...
<view class="jieguo" :style="{background: colors}">
 <view class="place">
  ...
  <view class="jieguo_box">
    ...
    <view class="texts">The loan payment is successful</view>
    <view class="moneys">￥{{sumprice}}</view>
    <view class="wancheng" @tap="onsuccess" :style="'color:' + colors + ';border-color:' + colors">Finish</view>
    <view class="ewm" @tap="jumpUser">Return to Personal Center>>></view>
  </view>
</view>
</template>
